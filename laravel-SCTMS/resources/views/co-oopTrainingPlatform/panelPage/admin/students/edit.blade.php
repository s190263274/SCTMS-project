                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent2">
                            <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                                ...
                                <form enctype="multipart/form-data" method="post" action="{{ route('adminPanel.students.update', $student->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="name" type="text" class="form-control" required="required" value="{{ $student->name }}" id="name">
                                                    <p class="help-block">
                                                        <ul></ul>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="email" type="email" class="form-control" required="required" value="{{ $student->email }}" id="email">
                                                    <p class="help-block">
                                                        <ul></ul>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="mobile_number" type="text" class="form-control" value="{{ $student->mobile_number }}" id="mobile_number">
                                                    <p class="help-block">
                                                        <ul></ul>
                                                    </p>
                                                </div>
