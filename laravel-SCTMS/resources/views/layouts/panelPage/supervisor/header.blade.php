    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('supervisorPanel.profile.show', ['id' => Auth::id()]) }}" class="dropdown-item has-icon">
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/supervisorPanel" class="nav-link"><i class="fas fa-fire"></i><span>Supervisor Panel</span></a></li>

            <li class="dropdown">
                <a href="{{ route('supervisor.coops.index') }}" class="nav-link">
            ...
            <li class="dropdown">
                <a href="{{ route('supervisor.evaluate.index') }}" >
            ...
            <li class="dropdown">
                <a href="{{ route('supervisor.queries.index') }}" >
